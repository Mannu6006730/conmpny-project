          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-muted-foreground">Choose from our most loved brands and categories</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              <img src={smartPayflexLogo} alt="SmartPayflex" className="h-16 w-auto" />
            </div>
            <p className="text-muted-foreground">Making gifting simple, instant, and memorable.</p>
          </div>
        </div>
      </footer>
    </div>
